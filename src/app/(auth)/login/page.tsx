 ...
 *
 * Two sign-in methods side by side:
 *   1. Continue with Google (primary — uses Google OAuth)
 *   2. Shared access (fallback — name + shared password)
 *
 * Styled in the sky-blue / white theme consistent with the main app.
 */
